            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 style="margin-top: 10px" class="logo me-auto"><a href="#">MediMap</a></h4>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub {{ ($daerah == "surabaya") ? 'active' : ''}}">
                            ...
                            <ul class="submenu {{ ($daerah == "surabaya") ? 'active' : ''}}">
                                ...
                                <li
                                    class="submenu-item {{ (($daerah == "surabaya") && ($jenis == "puskesmas")) ? 'active' : ''}}">
                                    <a href="{{route('surabaya.puskesmas')}}" class="submenu-link">Puskesmas</a>
                                </li>
                        ...
                        <li class="sidebar-item has-sub {{ ($daerah == "sidoarjo") ? 'active' : ''}}">
                            ...
                            <ul class="submenu {{ ($daerah == "sidoarjo") ? 'active' : ''}}">
                                ...
                                <li
                                    class="submenu-item {{ (($daerah == "sidoarjo") && ($jenis == "puskesmas")) ? 'active' : ''}}">
                                    <a href="{{route('sidoarjo.puskesmas')}}" class="submenu-link">Puskesmas</a>
                                </li>
                        ...
                        <li class="sidebar-item has-sub {{ ($daerah == "gresik") ? 'active' : ''}}">
                            ...
                            <ul class="submenu {{ ($daerah == "gresik") ? 'active' : ''}}">
                                ...
                                <li
                                    class="submenu-item {{ (($daerah == "gresik") && ($jenis == "puskesmas")) ? 'active' : ''}}">
                                    <a href="{{route('gresik.puskesmas')}}" class="submenu-link">Puskesmas</a>
                                </li>
