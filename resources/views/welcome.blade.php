...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" style="margin-top: 200px">
      <h6 style="margin-bottom: 15px">SISTEM INFORMASI GEOGRAFIS</h6>
      <h1>pelayanan <br> kesehatan</h1>
      <h6 style="margin-top: 15px">Sistem Informasi ini merupakan aplikasi pemetaan geografis tempat pelayanan <br> kesehatan di wilayah Surabaya, Gresik dan Sidoarjo. Aplikasi ini memuat <br> informasi dan lokasi dari tempat pelayanan kesehatan di daerah tersebut</h6>
