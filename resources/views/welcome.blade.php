...
<head>
  ...
  <title>GIS Pelayanan Kesehatan</title>
  ...
  <link
        rel="shortcut icon"
        href="/mazer/dist/assets/compiled/svg/favicon.svg"
        type="image/x-icon"
    />
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">MediMap</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" style="margin-top: 200px">
      ...
      <h1>pelayanan <br> kesehatan</h1>
      <h6 style="margin-top: 15px">Sistem Informasi ini merupakan aplikasi pemetaan geografis tempat pelayanan <br> kesehatan di wilayah Surabaya, Gresik dan Sidoarjo. Aplikasi ini memuat <br> informasi dan lokasi dari tempat pelayanan kesehatan di daerah tersebut agar <br> masyarakat dapat mudah mencari informasi tentang pelayanan kesehan</h6>
